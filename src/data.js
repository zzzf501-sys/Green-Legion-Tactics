// ==================== 鏁版嵁 ====================
const UNIT_DATA={
  '士兵':{hp:1.5,armor:0,speed:3,damage:1,range:2,price:1,attacks:1,vision:4},
  '坦克':{hp:10,armor:2,speed:5,damage:4,range:3,price:7,attacks:1,vision:4},
  '军用吉普':{hp:3,armor:0,speed:8,damage:2,range:3,price:3,attacks:1,vision:7},
  '火箭炮':{hp:10,armor:0,speed:2,damage:7,range:15,price:18,attacks:1,vision:3},
  '野战炮':{hp:3,armor:1,speed:3,damage:5,range:6,price:5,attacks:1,vision:4},
  '装甲车':{hp:6,armor:1,speed:5,damage:1.5,range:3,price:6,attacks:3,canTargetAir:true,vision:5},
  '战斗机':{hp:5,armor:1,speed:10,damage:5.5,range:3,price:8,attacks:1,isAir:true,canTargetAir:true,vision:9},
  '轰炸机':{hp:16,armor:3,speed:5,damage:12,range:1,price:15,attacks:1,isAir:true,blast:1.5,reload:1,vision:6},
  '防空车':{hp:5,armor:1,speed:5,damage:3,range:4,price:10,attacks:1,canTargetAir:true,airDamage:8,airRange:14,vision:5},
  '自杀无人机':{hp:2,armor:0,speed:8,damage:4,range:1,price:2,attacks:1,selfDestruct:true,vision:5},
  '侦察机':{hp:2.5,armor:0,speed:12,damage:0,range:0,price:5,attacks:0,isAir:true,vision:11},
}
const U_NAMES=Object.keys(UNIT_DATA)
const BUILDING_DATA={
  '大本营':{tiers:[
    {hp:25,armor:0,gold:3,upgradeCost:10,upgradeTime:3,vision:7},
    {hp:50,armor:0.5,gold:5,upgradeCost:30,upgradeTime:5,vision:8},
    {hp:85,armor:1,gold:8,vision:9},
  ]},
  '据点':{hp:20,armor:0,gold:3,vision:5},
  '资源采集器':{hp:15,armor:0,gold:2,cost:8,vision:3},
}
const EQUIP_DATA={
